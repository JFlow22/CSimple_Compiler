...
SID:					id OSQRERACKET EXPR CSQRERACKET COMMA SID {$$=mknode("ID",$1,$6,mknode("SIZE",$3,NULL,NULL,NULL),NULL);}
						| id OSQRERACKET EXPR CSQRERACKET {$$=mknode("ID",$1,NULL,mknode("SIZE",$3,NULL,NULL,NULL),NULL);}
						;
