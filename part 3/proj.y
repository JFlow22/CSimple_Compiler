...
START:					PROGRAM {/*pre($1,0);*/scanTree($1->left,&global);checkMainOnce();
...
FUNCTION:				TYPE id OBRACKET F_PARAMS CBRACKET CODE_BLOCK {
						...
						|
						void id OBRACKET F_PARAMS CBRACKET CODE_BLOCK {
						char num[33];
						$$=mknode("FUNCTION",$1,$2,$4,$6);
...
F_PARAMSS:				F_PARAMSS COMMA PARAM {$$=mknode("FPARAM",$1,$3,NULL,NULL);}
...
*/
PARAM:					PARAM_TYPE id {$$=mknode($1->token,$2,NULL,NULL,NULL);}
						;
						

VAR_DECLERACTION:		TYPE IDS SEMI {$$=mknode("IDS",$1,$2,NULL,NULL);}
...
SID:					id OSQRERACKET EXPR CSQRERACKET COMMA SID {$$=mknode("ID",$1,$6,mknode("SIZE",$3,NULL,NULL,NULL),NULL);countBeginFunc+=4;}
						| id OSQRERACKET EXPR CSQRERACKET {$$=mknode("ID",$1,NULL,mknode("SIZE",$3,NULL,NULL,NULL),NULL);countBeginFunc+=4;}
						;
...
ASSIGNMENT:				ASSIGNMENT_VAR assign EXPR SEMI{
						...
						| BXOR ASSIGNMENT_VAR assign EXPR SEMI{
